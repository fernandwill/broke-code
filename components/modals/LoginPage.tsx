...
const LoginPage: React.FC<LoginPageProps> = ({onChangeView}) => {
    return <form className="space-y-6 px-6 py-4">
        ...
        <button type="submit" className="w-full text-white focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-[#FF7A00] hover:bg-[#E86A00] transition duration-500 ease-in-out">Login</button>
        <button className="flex w-full justify-end" onClick={() => onChangeView("reset")}>
